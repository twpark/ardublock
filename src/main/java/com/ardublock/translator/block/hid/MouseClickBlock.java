...
public class MouseClickBlock extends TranslatorBlock
{
	public MouseClickBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
