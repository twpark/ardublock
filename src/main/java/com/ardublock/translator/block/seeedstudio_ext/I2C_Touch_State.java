...
public class I2C_Touch_State extends TranslatorBlock {

	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");

	public I2C_Touch_State(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException {
		...
		String number = this.getRequiredTranslatorBlockAtSocket(0).toCode();

		String ret = "_touchsensor.touched&(1<<" + number + ")";
